...
public class Tests {
    ...
    public static ArrayList<PriorityQueue.Patient> makeDeepCopy(ArrayList<PriorityQueue.Patient> list) {
        ArrayList<PriorityQueue.Patient> copy = new ArrayList<PriorityQueue.Patient>();
    ...
    public static void initialisePatientsAndHashMap() {
        ...
        testPatients.add(new PriorityQueue.Patient("Hannah",5));
        testPatients.add(new PriorityQueue.Patient("Ebony",10));
        testPatients.add(new PriorityQueue.Patient("Ahmad",15));
        testPatients.add(new PriorityQueue.Patient("Zil",30));
        testPatients.add(new PriorityQueue.Patient("Ricardo",60));
        testPatients.add(new PriorityQueue.Patient("Yinou",50));
        testPatients.add(new PriorityQueue.Patient("Gilbert",100));
    ...
    public void upHeapTest1(){
        ...
        ArrayList<PriorityQueue.Patient> truePatients = makeDeepCopy(testPriorityQueue.patients);
    ...
    public void upHeapTest3(){
        ...
        PriorityQueue.Patient karin = new PriorityQueue.Patient("Karin",4);
    ...
    public void upHeapTest4(){
        ...
        PriorityQueue.Patient karin = new PriorityQueue.Patient("Karin",100);
        PriorityQueue.Patient Loki = new PriorityQueue.Patient("Loki",5);
    ...
    public void getPriorityTest2(){
        ...
        ArrayList<PriorityQueue.Patient> truePatients = makeDeepCopy(emptyQueue.patients);
    ...
    public void removeMinTest2(){
        ...
        PriorityQueue.Patient Karin = new PriorityQueue.Patient("Karin",10);
    ...
    public void removeMinTest3() {
        ...
        PriorityQueue queue = new PriorityQueue();
        PriorityQueue.Patient Rio = new PriorityQueue.Patient("Rio", 1);
        PriorityQueue.Patient Julia = new PriorityQueue.Patient("Julia", 2);
        PriorityQueue.Patient Michael = new PriorityQueue.Patient("Michael", 13);
        ...
        ArrayList<PriorityQueue.Patient> truePatients = makeDeepCopy(queue.patients);
    ...
    public void addTest1_1(){
        ...
        PriorityQueue.Patient Hannah = testPriorityQueue.patients.get(1);
    ...
    public void addTest1_2(){
        ...
        PriorityQueue queue = new PriorityQueue();
        PriorityQueue.Patient Rio = new PriorityQueue.Patient("Rio", 5);
        ArrayList<PriorityQueue.Patient> truePatients = makeDeepCopy(queue.patients);
        HashMap<String,Integer> trueNameToIndex = new HashMap<>(queue.nameToIndex);
    ...
    public void addTest1_3(){
        ...
        PriorityQueue queue = new PriorityQueue();
        PriorityQueue.Patient Rio = new PriorityQueue.Patient("Rio", 5);
        PriorityQueue.Patient Julia = new PriorityQueue.Patient("Julia", 10);
        ArrayList<PriorityQueue.Patient> truePatients = makeDeepCopy(queue.patients);
        HashMap<String,Integer> trueNameToIndex = new HashMap<>(queue.nameToIndex);
        truePatients.add(Rio);
    ...
    public void addTest1_5(){
        ...
        PriorityQueue.Patient Rio = new PriorityQueue.Patient("Rio",9);
    ...
    public void addTest2_2(){
        ...
        truePatients.add(new PriorityQueue.Patient("Pete", Double.POSITIVE_INFINITY));
    ...
    public void addTest2_3(){
        ...
        PriorityQueue.Patient Jack = new PriorityQueue.Patient("Jack", Double.POSITIVE_INFINITY);
    ...
    public void removeTest2() {
        ...
        PriorityQueue.Patient Gilbert = truePatients.remove(7);
    ...
    public void removeTest3() {
        ...
        PriorityQueue.Patient Hannah = truePatients.remove(7);
    ...
    public void removeTest4() {
        ...
        PriorityQueue.Patient Ahmad = truePatients.remove(7);
    ...
    public void changePriorityTest2() {
        ArrayList<PriorityQueue.Patient> truePatients = makeDeepCopy(testPriorityQueue.patients);
        //System.out.println("Original list:" + truePatients);
        HashMap<String,Integer> trueNameToIndex = new HashMap<>(testPriorityQueue.nameToIndex);
        ...
        //System.out.println("Test truePatients:" + truePatients);
        //System.out.println("Test testPriorityQueue (changed priority):" + testPriorityQueue.patients);
        assertEquals(true, truePatients.equals(testPriorityQueue.patients));
        assertEquals(true, trueNameToIndex.equals(testPriorityQueue.nameToIndex));
    }
    ...
    public void removeUrgentPatientsTest1() {
        ...
        ArrayList<PriorityQueue.Patient> urgentList = testPriorityQueue.removeUrgentPatients(1);
    ...
    public void removeUrgentPatientsTest2() {
        PriorityQueue.Patient Gilbert = testPriorityQueue.patients.get(7);

        PriorityQueue trueQueue = new PriorityQueue();
        trueQueue.patients.add(new PriorityQueue.Patient(Gilbert.getName(), Gilbert.getPriority()));
        trueQueue.nameToIndex.put(Gilbert.getName(),1);
        System.out.println("TrueQueue: " + trueQueue.patients);

        ArrayList<PriorityQueue.Patient> trueUrgentList = makeDeepCopy(testPriorityQueue.patients);
        // Removing Gilbert
        trueUrgentList.remove(7);
        // Removing dummy
        trueUrgentList.remove(0);

        System.out.println("TestPriorityQueue: " + testPriorityQueue.patients);
        ArrayList<PriorityQueue.Patient> urgentList = testPriorityQueue.removeUrgentPatients(60);
    ...
    public void removeNonUrgentPatientsTest1() {
        ...
        ArrayList<PriorityQueue.Patient> nonUrgentList = testPriorityQueue.removeNonUrgentPatients(200);
    ...
    public void removeNonUrgentPatientsTest2() {
        ...
        ArrayList<PriorityQueue.Patient> urgentList = testPriorityQueue.removeNonUrgentPatients(1);
    ...
    public void removeNonUrgentPatientsTest3() {
        PriorityQueue.Patient Ricardo = testPriorityQueue.patients.get(5);
        PriorityQueue.Patient Gilbert = testPriorityQueue.patients.get(7);

        ArrayList<PriorityQueue.Patient> trueNonUrgentList = new ArrayList();
        trueNonUrgentList.add(new PriorityQueue.Patient(Ricardo.getName(), Ricardo.getPriority()));
        trueNonUrgentList.add(new PriorityQueue.Patient(Gilbert.getName(), Gilbert.getPriority()));
        ...
        ArrayList<PriorityQueue.Patient> nonUrgentList = testPriorityQueue.removeNonUrgentPatients(60);
